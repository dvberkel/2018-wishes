		...
		switch (_p1.ctor) {
			case 'Check':
				return _elm_lang$core$Native_Utils.eq(model.current, model.target) ? {
					...
					_1: _elm_lang$navigation$Navigation$load('two.html')
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
if (typeof _dummy$dummy$Combination$main !== 'undefined') {
    _dummy$dummy$Combination$main(Elm['Combination'], 'Combination', undefined);
}
