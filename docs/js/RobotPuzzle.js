...
var _dummy$dummy$RobotPuzzle$position_hash = function (_p2) {
	var _p3 = _p2;
	return (1997 * _p3._0) + _p3._1;
};
var _dummy$dummy$RobotPuzzle$init = function (program) {
	return {
		...
		_0: {
			...
			world: _dummy$dummy$CustomDict$empty(_dummy$dummy$RobotPuzzle$position_hash)
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
