...
var _dummy$dummy$CustomDict$get = F2(
	function (key, dictionary) {
		var lookup = dictionary.hash(key);
		var result = A2(_elm_lang$core$Dict$get, lookup, dictionary.dict);
		return result;
	});
var _dummy$dummy$CustomDict$update = F3(
	function (key, update, dictionary) {
		var lookup = dictionary.hash(key);
		var dict = A3(_elm_lang$core$Dict$update, lookup, update, dictionary.dict);
		return _elm_lang$core$Native_Utils.update(
			dictionary,
			{dict: dict});
	});
var _dummy$dummy$CustomDict$insert = F3(
	function (key, value, dictionary) {
		var lookup = dictionary.hash(key);
		var dict = A3(_elm_lang$core$Dict$insert, lookup, value, dictionary.dict);
		return _elm_lang$core$Native_Utils.update(
			dictionary,
			{dict: dict});
	});
var _dummy$dummy$CustomDict$empty = function (hash) {
	return {hash: hash, dict: _elm_lang$core$Dict$empty};
};
var _dummy$dummy$CustomDict$CustomDict = F2(
	function (a, b) {
		return {hash: a, dict: b};
	});
...
var _dummy$dummy$Robot$max_bounding_box = F2(
	function (_p6, _p5) {
		var _p7 = _p6;
		var _p8 = _p5;
		return {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Basics$max, _p7._0, _p8._0),
			_1: A2(_elm_lang$core$Basics$max, _p7._1, _p8._1)
		};
	});
var _dummy$dummy$Robot$filler = F2(
	function (_p9, world) {
		var _p10 = _p9;
		var position = {ctor: '_Tuple2', _0: _p10._0, _1: _p10._1};
		var occupations = A3(_dummy$dummy$CustomDict$insert, position, _p10._2, world.occupations);
		var bounding_box = A2(_dummy$dummy$Robot$max_bounding_box, position, world.bounding_box);
		return {occupations: occupations, bounding_box: bounding_box};
	});
var _dummy$dummy$Robot$position_hash = function (_p11) {
	var _p12 = _p11;
	return (1997 * _p12._0) + _p12._1;
};
var _dummy$dummy$Robot$emptyWorld = {
	occupations: _dummy$dummy$CustomDict$empty(_dummy$dummy$Robot$position_hash),
	bounding_box: {ctor: '_Tuple2', _0: 0, _1: 0}
};
var _dummy$dummy$Robot$fill = function (occupations) {
	return A3(_elm_lang$core$List$foldl, _dummy$dummy$Robot$filler, _dummy$dummy$Robot$emptyWorld, occupations);
};
var _dummy$dummy$Robot$World = F2(
	function (a, b) {
		return {occupations: a, bounding_box: b};
	});
...
var _dummy$dummy$Robot$getOccupation = F2(
	function (world, position) {
		return A2(
			...
			A2(_dummy$dummy$CustomDict$get, position, world.occupations));
	});
var _dummy$dummy$Robot$toOccupation = F3(
	function (y, x, $char) {
...
var _dummy$dummy$Robot$toOccupationLine = F2(
	function (y, line) {
		return A2(
			_elm_lang$core$List$indexedMap,
			_dummy$dummy$Robot$toOccupation(y),
			line);
	});
var _dummy$dummy$Robot$parse = function (input) {
	var lines = _elm_lang$core$String$lines(input);
	var characters = A2(_elm_lang$core$List$map, _elm_lang$core$String$toList, lines);
	var occupation_lines = A2(_elm_lang$core$List$indexedMap, _dummy$dummy$Robot$toOccupationLine, characters);
	var occupations = _elm_lang$core$List$concat(occupation_lines);
	return _dummy$dummy$Robot$fill(occupations);
};
		...
		if (_dummy$dummy$Robot$isEmpty(stack)) {
			...
			switch (_p18.ctor) {
				case 'Primitive':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Maybe$Just(_p18._0),
						_1: {program: tail}
					};
				case 'Sequence':
					var next_stack = {
						program: A2(_elm_lang$core$List$append, _p18._0, tail)
					};
					var _v13 = next_stack;
					stack = _v13;
					continue pop;
				default:
					var _p20 = _p18._1;
					var _p19 = _p18._0;
					if (_elm_lang$core$Native_Utils.cmp(_p19, 0) > 0) {
						var header = {
							ctor: '::',
							_0: _p20,
							_1: {
								ctor: '::',
								_0: A2(_dummy$dummy$Robot$Repeat, _p19 - 1, _p20),
								_1: {ctor: '[]'}
							}
						};
						var next_stack = {
...
var _dummy$dummy$Robot$step = F2(
	function (world, _p21) {
		var _p22 = _p21;
		var _p25 = _p22._0;
		var _p23 = _dummy$dummy$Robot$pop(_p22._1);
		var candidate = _p23._0;
		var next_stack = _p23._1;
		var next_robot = function () {
			var _p24 = candidate;
			if (_p24.ctor === 'Just') {
				return A3(_dummy$dummy$Robot$act, world, _p24._0, _p25);
			} else {
				return _p25;
			}
		}();
...
var _dummy$dummy$Parser$right = A2(
	_elm_community$parser_combinators$Combine_ops['$>'],
	_elm_community$parser_combinators$Combine$string('R'),
	_dummy$dummy$Robot$Primitive(_dummy$dummy$Robot$Right));
var _dummy$dummy$Parser$left = A2(
	_elm_community$parser_combinators$Combine_ops['$>'],
	_elm_community$parser_combinators$Combine$string('L'),
	_dummy$dummy$Robot$Primitive(_dummy$dummy$Robot$Left));
var _dummy$dummy$Parser$move = A2(
	_elm_community$parser_combinators$Combine_ops['$>'],
	_elm_community$parser_combinators$Combine$string('M'),
	_dummy$dummy$Robot$Primitive(_dummy$dummy$Robot$Move));
var _dummy$dummy$Parser$primitive = _elm_community$parser_combinators$Combine$choice(
	{
		ctor: '::',
		_0: _dummy$dummy$Parser$move,
		_1: {
			ctor: '::',
			_0: _dummy$dummy$Parser$left,
			_1: {
				ctor: '::',
				_0: _dummy$dummy$Parser$right,
				_1: {ctor: '[]'}
			}
		}
	});
var _dummy$dummy$Parser$repetition = function () {
	var what = function (n) {
		return A2(
			_elm_community$parser_combinators$Combine$map,
			_dummy$dummy$Robot$Repeat(n),
			_dummy$dummy$Parser$primitive);
	};
	var repeatProgram = A2(_elm_community$parser_combinators$Combine$andThen, what, _elm_community$parser_combinators$Combine_Num$int);
	return _elm_community$parser_combinators$Combine$lazy(
		function (_p0) {
			var _p1 = _p0;
			return _elm_community$parser_combinators$Combine$brackets(repeatProgram);
		});
}();
var _dummy$dummy$Parser$seq = function () {
	var options = _elm_community$parser_combinators$Combine$choice(
		{
			ctor: '::',
			_0: _dummy$dummy$Parser$primitive,
			_1: {
				ctor: '::',
	...
	var programs = A2(
		...
		_elm_community$parser_combinators$Combine$many1(options));
	return _elm_community$parser_combinators$Combine$lazy(
		function (_p2) {
			var _p3 = _p2;
			return programs;
...
var _dummy$dummy$Parser$compile = function (input) {
	...
	if (_p6.ctor === 'Ok') {
		return _elm_lang$core$Result$Ok(_p6._0._2);
	} else {
		return _elm_lang$core$Result$Err(
			A2(_elm_lang$core$String$join, ' or ', _p6._0._2));
	}
};
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Basics$toString(occupation),
								_1: true
							},
							_1: {
								ctor: '::',
...
var _dummy$dummy$RobotPuzzle$viewWorldRow = F2(
	function (model, y) {
		...
		var ds = A2(
			_elm_lang$core$List$map,
			A2(_dummy$dummy$RobotPuzzle$viewWorldPosition, model, y),
			xs);
		return A2(
...
var _dummy$dummy$RobotPuzzle$viewWorld = function (model) {
	...
	var ds = A2(
		_elm_lang$core$List$map,
		_dummy$dummy$RobotPuzzle$viewWorldRow(model),
		ys);
	return A2(
		_elm_lang$html$Html$div,
		{
...
if (typeof _dummy$dummy$RobotPuzzle$main !== 'undefined') {
    _dummy$dummy$RobotPuzzle$main(Elm['RobotPuzzle'], 'RobotPuzzle', undefined);
}
