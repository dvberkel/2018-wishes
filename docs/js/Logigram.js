...
var _dummy$dummy$FamilyDict$insert = F3(
...
var _dummy$dummy$FamilyDict$empty = function (hash) {
	return {hash: hash, dict: _elm_lang$core$Dict$empty};
};
var _dummy$dummy$FamilyDict$FamilyDict = F2(
	function (a, b) {
...
var _dummy$dummy$Logigram$view_hat = F2(
	function (dictionary, _p3) {
		...
		var _p6 = _p4._1;
		var chosen = function () {
			var _p5 = A2(_dummy$dummy$FamilyDict$get, _p7, dictionary);
			if (_p5.ctor === 'Just') {
