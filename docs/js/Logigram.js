...
var _dummy$dummy$Logigram$Sophie = {ctor: 'Sophie'};
var _dummy$dummy$Logigram$Marlies = {ctor: 'Marlies'};
var _dummy$dummy$Logigram$Daan = {ctor: 'Daan'};
var _dummy$dummy$Logigram$members = {
	ctor: '::',
	_0: _dummy$dummy$Logigram$Daan,
	_1: {
		ctor: '::',
		_0: _dummy$dummy$Logigram$Marlies,
		_1: {
			ctor: '::',
			_0: _dummy$dummy$Logigram$Sophie,
			_1: {
				ctor: '::',
				_0: _dummy$dummy$Logigram$Robin,
				_1: {
					ctor: '::',
					_0: _dummy$dummy$Logigram$Hannah,
					_1: {ctor: '[]'}
				}
			}
		}
...
var _dummy$dummy$Logigram$solved = function (logigram) {
	var correct_hats = function (member) {
		return _elm_lang$core$Native_Utils.eq(
			A2(_dummy$dummy$CustomDict$get, member, logigram.current),
			A2(_dummy$dummy$CustomDict$get, member, logigram.target));
	};
...
var _dummy$dummy$Logigram$update = F2(
	function (message, logigram) {
		var _p2 = message;
		if (_p2.ctor === 'Wears') {
			var next_current = A3(_dummy$dummy$CustomDict$insert, _p2._0, _p2._1, logigram.current);
			...
			var is_solved = _dummy$dummy$Logigram$solved(logigram);
			var next_message = is_solved ? _elm_lang$core$Maybe$Just('Correct') : _elm_lang$core$Maybe$Just('Incorrect');
			var next_model = _elm_lang$core$Native_Utils.update(
				logigram,
				{message: next_message});
			var next_command = is_solved ? _elm_lang$navigation$Navigation$load('celebrate.html') : _elm_lang$core$Platform_Cmd$none;
			return {ctor: '_Tuple2', _0: next_model, _1: next_command};
		}
	});
...
var _dummy$dummy$Logigram$init = function () {
	var target = A3(
		_dummy$dummy$CustomDict$insert,
			...
			A3(
				...
				A3(
					...
					A3(
						...
						_dummy$dummy$CustomDict$empty(_dummy$dummy$Logigram$family_hash))))));
	return {
		current: _dummy$dummy$CustomDict$empty(_dummy$dummy$Logigram$family_hash),
		target: target,
...
var _dummy$dummy$Logigram$view_hat = F2(
	function (dictionary, _p3) {
		var _p4 = _p3;
		var _p7 = _p4._0;
		var _p6 = _p4._1;
		var chosen = function () {
			var _p5 = A2(_dummy$dummy$CustomDict$get, _p7, dictionary);
			if (_p5.ctor === 'Just') {
		...
		return A2(
			_elm_lang$html$Html$span,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'chosen', _1: chosen},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'hat', _1: true},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						A2(_dummy$dummy$Logigram$Wears, _p7, _p6)),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'});
	});
var _dummy$dummy$Logigram$view_member = F2(
	function (dictionary, _p8) {
		var _p9 = _p8;
		var name = A2(
			_elm_lang$html$Html$span,
			{
		...
		var ds = {
			...
			_1: A2(
				_elm_lang$core$List$map,
				_dummy$dummy$Logigram$view_hat(dictionary),
				_p9._1)
		};
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('hats'),
				_1: {ctor: '[]'}
			},
			ds);
	});
...
var _dummy$dummy$Logigram$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _dummy$dummy$Logigram$init, _1: _elm_lang$core$Platform_Cmd$none},
		update: _dummy$dummy$Logigram$update,
		view: _dummy$dummy$Logigram$view,
		subscriptions: _dummy$dummy$Logigram$subscriptions
	})();

var Elm = {};
Elm['Logigram'] = Elm['Logigram'] || {};
if (typeof _dummy$dummy$Logigram$main !== 'undefined') {
    _dummy$dummy$Logigram$main(Elm['Logigram'], 'Logigram', undefined);
}
