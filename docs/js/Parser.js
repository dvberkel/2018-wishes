...
var _dummy$dummy$Parser$program = _Bogdanp$elm_combine$Combine$choice(
	{
		ctor: '::',
...
var _dummy$dummy$Parser$repetition = function () {
	var what = function (n) {
		return A2(
			...
			_dummy$dummy$Parser$program);
	};
	var repeatProgram = A2(_Bogdanp$elm_combine$Combine$andThen, what, _Bogdanp$elm_combine$Combine_Num$int);
	return _Bogdanp$elm_combine$Combine$brackets(repeatProgram);
}();
var _dummy$dummy$Parser$compile = function (input) {
	var _p0 = A2(_Bogdanp$elm_combine$Combine$parse, _dummy$dummy$Parser$program, input);
	if (_p0.ctor === 'Ok') {
